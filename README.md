...
> 本地可以同时装不同版本的Tex live环境，切换环境时可以去系统环境变量path处把想要使用版本的路径上移，比如想用2019版的编译，那么把2019的路径移到2025版的上面就可以。当然也可以去Texstudio里面做一些配置，那样就不用去移动path的路径了，配置可参考[科研干货 | 安装配置TeXLive和CTeX并实现自由切换](https://github.com)。
...
**编译环境：**[CTEX 2.9.2.167](https://github.com)
...
**解决方案**：下载`gb.cap`和`gb.cpx`两个文件（[下载链接](https://github.com)），拷贝至`CTEX\MiKTeX\tex\latex\cjk\GB`文件夹中，替换原有文件即可。
...
1. [如何编译通过《系统工程学报》LaTeX 模板](https://github.com)

* [1. 引言](#tid-EQHpH7)
* [2. 一般性解决方案](#tid-fEMmW8)
* [2.1. 官网下载区模板的上传日期](#tid-p5YPHw)
* [2.2. 模板本身信息](#tid-JAj7dy)
* [2.3. 网络搜索](#tid-h7rEJR)
* [2.4. 与原作者沟通](#tid-KYDKPd):[FlowerCloud花云机场](https://flowercloud6.com)
* [3. 中文模板](#tid-QdWNXA)
* [3.1. 投稿期刊](#tid-85pHjb)
* [3.1.1. 系统工程学报](#tid-CGNswG)
* [4. 外文模板](#tid-Z2iyEf)
* [5. 参考文章](#tid-QnGR5k)

\_\_EOF\_\_

Invinc-Z - **本文链接：** [https://github.com/Invinc-Z/p/19179918/solutions-latex-templetes-compile-errors](https://github.com)
